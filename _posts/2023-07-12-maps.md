...
<div class="blog-figure">
    {% include figure.liquid path="assets/img/post0_cover2.png" class="img-fluid" %}
</div>
...
<div class="blog-figure">
    {% include figure.liquid path="assets/img/road_network.png" class="img-fluid" %}
</div>
...
<div class="blog-figure">
    {% include figure.liquid path="assets/img/dijkstra.gif" class="img-fluid" caption="Dijkstra's in action! Notice how we only look at the shortest edge that is connected to the nodes that we've already looked at." %}
</div>
...
<div class="blog-figure">
    {% include figure.liquid path="assets/img/astar.gif" class="img-fluid" caption="A* in action! Here, we look at what we've already done as well as what we have left to do." %}
</div>
...
<div class="blog-figure">
    {% include figure.liquid path="assets/img/dstar.gif" class="img-fluid" caption="D* is pretty cool - notice how changes are propagated in real-time!" %}
</div>
